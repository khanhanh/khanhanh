...
public class main_assignment5 {
    public static void main(String[] args) {

        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/khanhanh?user=root&password=");
            System.out.println("Co ton tai nguoi dung nay ! ");
            Statement statement =conn.createStatement();
            String insert_sql="INSERT INTO user (id,username,email,password,status)"+ "VALUES('34590655','ngọc hà','ngocha232@gmail.com','ngocha',0)";
